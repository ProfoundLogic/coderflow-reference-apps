...
2. Build and launch it. The pre-clone script installs **JDK 21 (Temurin) + Maven**, the post-clone action installs dependencies, and the application server starts the API (port 3001) and the React dev server (port 5173).
