#!/usr/bin/env bash
#
# Reference Deploy Profile — PHP + React
# WHAT THIS SHOWS
...
#   React front end (static build) plus the PHP API
...
APP_DIR="/workspace/coderflow-reference-apps/php-react"
TARGET="${TARGET:-qa}"
DRY_RUN="${DRY_RUN:-true}"

echo "=================================================="
echo " CoderFlow reference deploy — PHP + React"
echo "   Target:   ${TARGET}"
