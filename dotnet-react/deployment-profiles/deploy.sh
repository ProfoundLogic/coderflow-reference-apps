#!/usr/bin/env bash
#
# Reference Deploy Profile — .NET + React
# WHAT THIS SHOWS
...
#   React front end (static build) plus the .NET API
...
APP_DIR="/workspace/coderflow-reference-apps/dotnet-react"
TARGET="${TARGET:-qa}"
DRY_RUN="${DRY_RUN:-true}"

echo "=================================================="
echo " CoderFlow reference deploy — .NET + React"
echo "   Target:   ${TARGET}"
