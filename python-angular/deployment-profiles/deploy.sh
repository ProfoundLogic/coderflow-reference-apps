#!/usr/bin/env bash
#
# Reference Deploy Profile — Python + Angular
# WHAT THIS SHOWS
...
#   Angular front end (static build) plus the Python API
...
APP_DIR="/workspace/coderflow-reference-apps/python-angular"
TARGET="${TARGET:-qa}"
DRY_RUN="${DRY_RUN:-true}"

echo "=================================================="
echo " CoderFlow reference deploy — Python + Angular"
echo "   Target:   ${TARGET}"
