#!/usr/bin/env bash
#
# Reference Deploy Profile — Java + React
# WHAT THIS SHOWS
...
#   React front end (static build) plus the Java API
...
APP_DIR="/workspace/coderflow-reference-apps/java-react"
TARGET="${TARGET:-qa}"
DRY_RUN="${DRY_RUN:-true}"

echo "=================================================="
echo " CoderFlow reference deploy — Java + React"
echo "   Target:   ${TARGET}"
