#!/usr/bin/env bash
#
# Reference Deploy Profile — Python + Vue
# WHAT THIS SHOWS
...
#   Vue front end (static build) plus the Python API
...
APP_DIR="/workspace/coderflow-reference-apps/python-vue"
TARGET="${TARGET:-qa}"
DRY_RUN="${DRY_RUN:-true}"

echo "=================================================="
echo " CoderFlow reference deploy — Python + Vue"
echo "   Target:   ${TARGET}"
