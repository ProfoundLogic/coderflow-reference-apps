#!/usr/bin/env bash
#
# Reference Deploy Profile — PHP + Angular
# WHAT THIS SHOWS
...
#   Angular front end (static build) plus the PHP API
...
APP_DIR="/workspace/coderflow-reference-apps/php-angular"
TARGET="${TARGET:-qa}"
DRY_RUN="${DRY_RUN:-true}"

echo "=================================================="
echo " CoderFlow reference deploy — PHP + Angular"
echo "   Target:   ${TARGET}"
