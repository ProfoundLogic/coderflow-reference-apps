#!/usr/bin/env bash
#
# Reference Deploy Profile — Java + Angular
# WHAT THIS SHOWS
...
#   Angular front end (static build) plus the Java API
...
APP_DIR="/workspace/coderflow-reference-apps/java-angular"
TARGET="${TARGET:-qa}"
DRY_RUN="${DRY_RUN:-true}"

echo "=================================================="
echo " CoderFlow reference deploy — Java + Angular"
echo "   Target:   ${TARGET}"
