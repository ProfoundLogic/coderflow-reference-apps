#!/usr/bin/env bash
#
# Reference Deploy Profile — .NET + Vue
# WHAT THIS SHOWS
...
#   Vue front end (static build) plus the .NET API
...
APP_DIR="/workspace/coderflow-reference-apps/dotnet-vue"
TARGET="${TARGET:-qa}"
DRY_RUN="${DRY_RUN:-true}"

echo "=================================================="
echo " CoderFlow reference deploy — .NET + Vue"
echo "   Target:   ${TARGET}"
