...
2. Build and launch it. The pre-clone script installs **JDK 17 + Maven**, the post-clone action installs dependencies, and the application server starts the API (port 3001) and the Angular dev server (port 4200).
