...
2. Build and launch it. The pre-clone script installs **Python 3 (pip)**, the post-clone action installs dependencies, and the application server starts the API (port 3001) and the Angular dev server (port 4200).
...
from Angular, the API's message ("Hello from the Python API!") fetched
