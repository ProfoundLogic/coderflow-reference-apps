...
2. Build and launch it. The pre-clone script installs **Node.js 24 (npm)**, the post-clone action installs dependencies, and the application server starts the API (port 3001) and the React dev server (port 5173).
...
from React, the API's message ("Hello from the Node.js API!") fetched
