#!/usr/bin/env bash
#
# Reference Deploy Profile — Node.js + Vue
# WHAT THIS SHOWS
...
#   Vue front end (static build) plus the Node.js API
...
APP_DIR="/workspace/coderflow-reference-apps/node-vue"
TARGET="${TARGET:-qa}"
DRY_RUN="${DRY_RUN:-true}"

echo "=================================================="
echo " CoderFlow reference deploy — Node.js + Vue"
echo "   Target:   ${TARGET}"
